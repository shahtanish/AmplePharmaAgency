...
<div class="container">
    <div class="card">
    <div class="card-head" style="background-color:green;">
...
$sql1 = "SELECT dname, oid FROM ordermaster WHERE status = 'completed' AND tdate BETWEEN '$fromDate' AND '$toDate'";
...
fetch('fetch_product_details.php', {
    ...
    .then(data => {
        ...
        if (data.status === 'success') {
            formatDetails(data.details,detailsId);
        } else {
...
function formatDetails(details, detailsContainerId) {
